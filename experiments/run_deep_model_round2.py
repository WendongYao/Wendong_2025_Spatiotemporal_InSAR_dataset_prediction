"""
Second-round deep model architecture search on the repaired patch-residual pipeline.

Revision skeleton alignment:
- Structural follow-up after fixing the original deep-learning data pipeline
- Candidate backends: temporal-channel CNN, patch U-Net residual, and 3D conv residual
"""
...
from cg_additional_experiments import (
    run_conv_lstm_residual_experiment,
    run_conv3d_residual_experiment,
    run_patch_unet_residual_experiment,
    run_temporal_linear_hybrid_experiment,
    run_temporal_channel_cnn_experiment,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Second-round deep architecture search.")
    ...
    parser.add_argument("--output-root", type=str, default="revision_outputs/deep_model_round2")
    ...
    model_fns = {
        "temporal_channel_cnn": run_temporal_channel_cnn_experiment,
        "patch_unet_residual": run_patch_unet_residual_experiment,
        "conv3d_residual": run_conv3d_residual_experiment,
        "temporal_linear_hybrid": run_temporal_linear_hybrid_experiment,
        "conv_lstm_residual": run_conv_lstm_residual_experiment,
    }
    ...
    _write_rows(rows, output_root / "round2_seed_level.csv")
    _write_rows(summary_rows, output_root / "round2_summary.csv")
