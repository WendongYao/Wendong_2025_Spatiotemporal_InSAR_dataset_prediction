...
add_box(ax, 0.02, 0.39, 0.15, 0.22, "Native-cell history\n$\\mathbf{x}_i\\in\\mathbb{R}^{300}$", "#EAF1F8", COLORS["baseline"])
...
add_box(ax, 0.71, 0.62, 0.22, 0.20, "L3 product-cell forecast\n$\\hat y_i=f_{\\mathrm{LASSO}}+\\sigma_\\Delta\\alpha r_\\theta$", "#F7EAF4", COLORS["purple"])
...
add_arrow(ax, 0.41, 0.72, 0.71, 0.72, color=COLORS["secondary"])
