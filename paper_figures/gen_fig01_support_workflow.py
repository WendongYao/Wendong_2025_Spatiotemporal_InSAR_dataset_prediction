...
ax.text(0.01, 0.89, "(a) Gridding-first formulation", weight="bold", va="center")
ax.text(0.01, 0.39, "(b) Support-preserving formulation", weight="bold", va="center")

box(ax, (0.02, 0.63), (0.18, 0.16), "Irregular point\nhistories", "#EAF1F8", COLORS["baseline"])
box(ax, (0.27, 0.63), (0.20, 0.16), "Interpolate histories\nand future target", "#FCE8E6", COLORS["warning"])
box(ax, (0.54, 0.63), (0.17, 0.16), "Dense sequence\nmodel", "#F2F2F2", "#666666")
box(ax, (0.78, 0.63), (0.19, 0.16), "Dense-grid error\n(operator-coupled)", "#FCE8E6", COLORS["warning"])
...
box(ax, (0.59, 0.12), (0.18, 0.16), "Direct raw forecast\nand primary error", "#E7F4EA", COLORS["secondary"])
...
ax.text(0.72, 0.04, "secondary output; interpolation-sensitive", color="#666666", ha="center", fontsize=8)
